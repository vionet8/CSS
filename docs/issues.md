...
### LPテンプレート複数化（2026-07-07 追加・M11）

- LPテンプレート3種: **standard**（カード型）/ **salesletter**（縦長・セールス構造分析のノードを本文セクションとして流し込み、ベネフィットはチェックリスト）/ **minimal**（キャッチコピー特化1画面型）
- **キャッチコピー差し替え**: キャッチコピー素材（10案）から選んだ案をヒーロー見出しに差し替え可能（`catchcopy_index`）
- テスト7件追加（合計65件）
